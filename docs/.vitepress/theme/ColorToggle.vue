...
<template>
  <div class="wrap">
    <button @click="toggleDark()">
      <svg width="1em" height="1em" viewBox="0 0 24 24" v-if="!isDark">
        <path
          fill="currentColor"
      ...
      <svg width="1em" height="1em" viewBox="0 0 24 24" v-else>
        <path
          fill="currentColor"
...
button {
  --clea-base-color: --clea-base-color-invert;
  --clea-base-color-invert: --clea-base-color;
